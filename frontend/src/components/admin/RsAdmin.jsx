...
const RaAdmin = () => {
  ...
  const fetchUsers = async () => {
    setLoading(true)
    try {
      const response = await axios.get("http://localhost:8000/api/users/rs")
                        ...
                        <tr key={user.id} className={index % 2 === 0 ? (darkMode ? "bg-gray-800" : "bg-gray-50") : ""}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            ...
                            <button onClick={() => handleEdit(user)}
                              className="text-[#0927EB] dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 p-1 rounded-md hover:bg-indigo-50 dark:hover:bg-gray-700"
                                title="Modifier"
                            >
                            ...
                            <button
                                ...
                                className=" dark:text-red-400 hover:text-red-900 dark:hover:text-red-300 p-1 rounded-md hover:bg-red-50 dark:hover:bg-gray-700"
                                title="Supprimer"
                            >
