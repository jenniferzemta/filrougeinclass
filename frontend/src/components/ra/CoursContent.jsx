...
//           setError('Erreur lors de la soumission du cours');
//         }
//   };
...
//                       {/* Matière */}
//                       <div>
//                         <label htmlFor="matieres_id" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
//                           Matière
//                         </label>
//                         <select
//                           id="matieres_id"
...
//                       {/* Salle */}
//                       <div>
//                         <label htmlFor="salles_id" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
//                           Salle
//                         </label>
//                         <select
//                           id="salles_id"
...
//                       {/* Enseignant */}
//                       <div>
//                         <label htmlFor="enseignant_id" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
//                           Enseignant
//                         </label>
//                         <select
//                           id="enseignant_id"
...
//                       {/* Périodicité */}
//                       <div>
//                         <label htmlFor="periodicite" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
//                           Périodicité
//                         </label>
//                         <select
//                           id="periodicite"
...
//                       {/* Heure de début */}
//                       <div>
//                         <label htmlFor="heure_deb" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
//                           Heure de début
//                         </label>
//                         <input
//                           type="time"
...
//                       {/* Heure de fin */}
//                       <div>
//                         <label htmlFor="heure_fin" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
//                           Heure de fin
//                         </label>
//                         <input
//                           type="time"
